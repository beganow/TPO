...
(function run() {
    ...
    console.log(Airport.print(militaryAirport.sortByMaxDistance()));

    console.log('Passenger airport sorted by max speed:');
    console.log(Airport.print(passengerAirport.sortByMaxSpeed()));

    console.log('Plane with max passenger capacity:');
    console.log(Airport.print(passengerAirport.getPassengerPlaneWithMaxPassengersCapacity()));
})();